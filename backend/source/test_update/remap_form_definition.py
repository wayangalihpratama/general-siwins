...
prev_file = "./source/test_update/orms/647170919.json"
new_file = "./source/test_update/new_form.json"
...
with open("./source/test_update/remapped_form.json", "w") as json_file:
